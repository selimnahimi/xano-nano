...
class CWeaponCLCrossbow : public CBaseHLCombatWeapon
{
	DECLARE_CLASS(CWeaponCLCrossbow, CBaseHLCombatWeapon);
public:

	CWeaponCLCrossbow(void);
...
LINK_ENTITY_TO_CLASS(weapon_clcrossbow, CWeaponCLCrossbow);

PRECACHE_WEAPON_REGISTER(weapon_clcrossbow);

IMPLEMENT_SERVERCLASS_ST(CWeaponCLCrossbow, DT_WeaponCLCrossbow)
END_SEND_TABLE()

BEGIN_DATADESC(CWeaponCLCrossbow)
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponCLCrossbow::CWeaponCLCrossbow(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::Precache(void)
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::PrimaryAttack(void)
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::SecondaryAttack(void)
{
...
//-----------------------------------------------------------------------------
bool CWeaponCLCrossbow::Reload(void)
{
	WeaponSound(RELOAD);
	if (BaseClass::Reload())
	{
		...
		pOwner->SetAmmoCount(ammo - ammo_toadd, m_iPrimaryAmmoType);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::CheckZoomToggle(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::ItemBusyFrame(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::ItemPostFrame(void)
{
	// Allow zoom toggling
	CheckZoomToggle();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::FireBolt(void)
{
	if (m_iClip1 <= 0)
	{
		if (!m_bFireOnEmpty)
	...
	m_flNextPrimaryAttack = m_flNextSecondaryAttack = gpGlobals->curtime + 0.075;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CWeaponCLCrossbow::Deploy(void)
{
	if (m_iClip1 <= 0)
	{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CWeaponCLCrossbow::Holster(CBaseCombatWeapon *pSwitchingTo)
{
	StopEffects();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::ToggleZoom(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::CreateChargerEffects(void)
{
	CBasePlayer *pOwner = ToBasePlayer(GetOwner());
...
// Input  : skinNum - 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::SetSkin(int skinNum)
{
	CBasePlayer *pOwner = ToBasePlayer(GetOwner());
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::DoLoadEffect(void)
{
	SetSkin(BOLT_SKIN_GLOW);
...
// Input  : state - 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::SetChargerState(ChargerState_t state)
{
...
//			*pOperator - 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
//-----------------------------------------------------------------------------
bool CWeaponCLCrossbow::SendWeaponAnim(int iActivity)
{
...
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::StopEffects(void)
{
	// Stop zooming
	if (m_bInZoom)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponCLCrossbow::Drop(const Vector &vecVelocity)
{
	StopEffects();
